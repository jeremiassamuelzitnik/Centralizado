...
{
    $respuesta=[System.Windows.MessageBox]::Show("Este software instala un servicio en el equipo y puede realizar ejecuciones remotas. ¿Desea continuar?.", "Advertencia", "YesNo", "Question")
