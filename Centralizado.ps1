...
{
    $respuesta=[System.Windows.MessageBox]::Show("Este software instala un servicio en el equipo y puede realizar ejecuciones remotas. Dar Click en si para continuar.", "Advertencia", "YesNo", "Question")
